...
def Show_threshold(img):
    # 显示当前阈值，使用更美观的格式
    threshold_text = "当前阈值: L[{},{}] A[{},{}] B[{},{}]".format(xunji_threshold[0], xunji_threshold[1], xunji_threshold[2], xunji_threshold[3], xunji_threshold[4], xunji_threshold[5])
    ...
    current_param = "当前调节: {} = {}".format(param_names[threshold_index], xunji_threshold[threshold_index])
